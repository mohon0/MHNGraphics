      ...
      <section className='px-2 py-20'>
        <div className='container mx-auto max-w-4xl'>
          ...
          <div className='space-y-6 text-lg text-muted-foreground'>
            <p>
              Oylkka IT was born out of a passion for design and a vision to
            ...
            >
              ...
              <p>
                Today, Oylkka IT stands at the forefront of the design industry,
                continuously pushing boundaries and setting new standards.
                We&apos;re not just creating designs; we&apos;re crafting
                experiences that resonate with audiences and drive results for
                our clients.
              </p>
            </motion.div>
