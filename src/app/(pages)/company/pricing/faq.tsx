...
const faqs = [
  {
    question: "What services does MHN Graphics offer?",
    answer:
      "MHN Graphics offers a wide range of design services including branding, web design, UI/UX design, print design, and motion graphics. We cater to businesses of all sizes, from startups to large enterprises.",
  },
  {
