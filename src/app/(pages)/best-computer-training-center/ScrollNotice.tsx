import logo from "@/images/best-computer/icon.png";
...
export default function ScrollNotice() {
  return (
    <div className="mx-2 my-2 flex grid-cols-1 flex-col items-center justify-center gap-4 md:grid md:grid-cols-12 md:gap-0 lg:mx-10">
      <div className="bg-primary-100 flex w-full items-center justify-center gap-2 rounded-md p-1 md:col-span-3 lg:col-span-2">
      ...
      <Marquee
        pauseOnHover={true}
        className="col-span-9 h-full border-y border-l border-r border-primary font-bold md:border-l-0 md:text-2xl lg:col-span-10"
      >
