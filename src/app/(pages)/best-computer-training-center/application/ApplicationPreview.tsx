          ...
          <div>
            ...
            <div className='mt-3 border p-2 text-sm md:mx-10 print:mx-10 print:text-black'>
              <p>
                ...
                সন্তান/পোষ্য, এর যাবতীয় ব্যয়ভার এবং আমার সন্তান/পোষ্য প্রতিষ্ঠানের এর নিয়ম
                শৃঙ্খলা ভঙ্গ করিলে বা অন্য কোনো কারণে প্রতিষ্ঠানের জন্য ক্ষতিকর বিবেচিত হইলে
                কতৃপক্ষের যে কোন সিধান্ত মানিয়া লইতে বাধ্য থাকিব।
              </p>
            </div>
            ...
            <div className='flex flex-col items-end justify-between gap-8 md:mx-10 md:flex-row md:gap-0 print:mx-10 print:flex-row print:gap-0'>
              <div className='mt-2 w-fit border p-2 text-sm print:text-black'>
                ...
                <p>
                  ৪. ভর্তি হওয়ার পর, পরবর্তীতে ভর্তি বাতিল করতে চাইলে সে <br /> ক্ষেত্র
                  কোন টাকা ফেরত দেওয়া হবে না।
                </p>
              </div>
