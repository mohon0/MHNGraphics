      ...
      >
        <div className="flex h-full flex-col items-center justify-between px-6 py-10">
          ...
          <div className="flex gap-5">
            <button className="hover:bg-primary-300 rounded border bg-white p-2 text-sm font-bold text-orange-600 shadow-lg transition-all duration-300 hover:text-white">
              আরও জানুন
            </button>
            <button className="hover:bg-primary-300 rounded border bg-white p-2 text-sm font-bold text-orange-600 shadow-lg transition-all duration-300 hover:text-white">
              এখন কিনুন
